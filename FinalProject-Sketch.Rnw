...
The dataset that we have is reviews of all the different businesses written by yelp users in the Phoenix, Arizona metropolitan area in the time frame of January 13-March 12 in 2013. Our analysis is using the reviews given to us and identify which reviews were classified as useful based on only the number of stars the user gave the business, the total number of reviews by the user, the average star given by the user, and the text data of the review. Our initial analysis plan is using the text data given to us and...

\section*{Data}
The data has been broken into 3 main datasets business.json, user.json, and reviews.json.
...
<<UsefulFunny, echo=FALSE, out.height='5in', out.width='5in', fig.show='hold', fig.align='center'>>=
...
<<CheckinsBoxplot, echo=FALSE, out.height='5in', out.width='5in', fig.show='hold', fig.align='center'>>=
